[chui](../../index.md) › [chui.core](index.md) › Axis

# Axis

`chui.core` 包中的 public enum

布局方向轴：水平或垂直。[`Divider`](Divider.md) 用它选择走向，[`Widget.acceptsStretch`](Widget.md#acceptsstretch) 用它询问某个轴上能否拉伸，`chui.controls` 的拆分视图用它选择分割方向。
